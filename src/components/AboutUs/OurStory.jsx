...
const OurStory = () => {
  return (
    <section className="flex justify-center items-center w-full py-10">
      <div className="w-1/2">
        <h2 className="font-poppins font-semibold xs:text-[38px] text-[30px] mb-6">
          Our Story
        </h2>
        <p className="font-poppins font-normal text-[18px] text-justify my-3">
        ...
        <p className="font-poppins font-normal text-[18px] text-justify mb-3">
        ...
        <p className="font-poppins font-normal text-[18px] mb-6 text-justify">
        ...
        <p className="font-poppins text-[16px] my-6 text-justify italic">
