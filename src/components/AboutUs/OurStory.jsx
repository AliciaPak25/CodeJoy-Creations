  ...
  return (
    <section className="flex justify-center items-center w-full py-10">
      <div className="md:w-1/2 ss:w-3/4 w-11/12">
        ...
        <p className="font-normal ss:text-[18px] text-justify mb-3">
        ...
        <p className="font-normal ss:text-[18px] mb-6 text-justify">
        ...
        <p className="ss:text-[16px] text-[14px] my-6 text-justify italic">
