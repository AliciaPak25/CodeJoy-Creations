...
const Hero = () => {
  return (
    <div className="h-screen hero-background">
      <div className="text-center flex items-center flex-col justify-center bg-black/80 h-screen w-full">
        ...
        <p className="font-light text-2xl mt-4 text-white">
          Beyond code, we are a community unlocking possibilities together
        </p>
