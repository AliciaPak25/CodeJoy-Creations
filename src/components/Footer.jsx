  ...
  return (
    <section className="flex flex-col justify-center items-center py-6 bg-[#171717] w-full">
      <div className="flex justify-between items-center flex-row mb-8 w-full">
        <div className="flex flex-col justify-start mr-10 sm:w-1/2">
          <div className="flex items-center mx-10">
            <Logo />
            <p className="text-white text-[20px] font-poppins font-bold leading-[27px] ml-2">
              CodeJoy Creations
            </p>
          </div>
          <p className="font-poppins font-normal text-[18px] leading-[18px] mt-4 text-[#626262] mx-10">
            ...
            <div key={footerLink.links.id} className="mt-10">
              ...
              <ul className="list-none mt-4 md:flex">
                {footerLink.links.map((link, index) => (
                  <li
                    key={link.name}
                    className={`font-poppins font-normal text-[16px] leading-[24px] text-[#757575] hover:text-secondary cursor-pointer mx- ${
      ...
      <div className="w-full flex justify-between items-center flex-col pt-6 border-t-[1px] border-t-[#626262]">
        <p
          className="font-poppins font-normal text-center text-[18px] text-[#626262] leading-[27px] mb-2
  "
        >
          &copy; Copyright CodeJoy Creations 2023 - All rights are reserved.
        </p>
        <p className="font-poppins font-normal text-center text-[18px] text-[#626262] leading-[27px]">
